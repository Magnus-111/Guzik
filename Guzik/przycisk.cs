...
namespace Guzik
{
    ...
    public partial class przycisk : UserControl
    {
        ...
        {
            InitializeComponent();
            int style = antymigot.NativeWinAPI.GetWindowLong(Handle, antymigot.NativeWinAPI.GWL_EXSTYLE);
            style |= antymigot.NativeWinAPI.WS_EX_COMPOSITED;
            antymigot.NativeWinAPI.SetWindowLong(Handle, antymigot.NativeWinAPI.GWL_EXSTYLE, style);
        }
